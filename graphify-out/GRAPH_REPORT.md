# Graph Report - ecommerce-v2 (2026-05-30)

## Corpus Check

- 1687 files · ~1,603,906 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 23573 nodes · 41977 edges · 706 communities (588 shown, 118 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 529 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `4714ecc3`
...
## Communities (706 total, 118 thin omitted)
...
Cohesion: 0.0
Nodes (495): $148a7a147e38ea7f$export$702d680b21cbd764(), $1e5a04cdaf7d1af8$export$f09106e7c6677ec5(), $1e5a04cdaf7d1af8$var$updateLocale(), $507fabe10e71c6fb$export$2f1888112f558a7d(), $507fabe10e71c6fb$var$handleClickEvent(), $507fabe10e71c6fb$var$setupGlobalFocusEvents(), $6179b936705e76d3$var$handleGlobalPointerEvent(), $6179b936705e76d3$var$setGlobalIgnoreEmulatedMouseEvents() (+487 more)

### Community 2 - "Shop Domain Models"

Cohesion: 0.01
Nodes (436): "node_modules/is-window/index.js"(), $2a41e45df1593e64$var$translateRTL(), $9bf71ea28793e738$var$isTabbableRadio(), alloc(), appendErrorRef(), areObjectsEqual(), arrayFromSet(), arrayFromSet2() (+428 more)
...
Cohesion: 0.01
Nodes (340): $0065b146e7192841$export$7138b0d059a6e743(), $0175d55c2a017ebc$export$fdf4756d5b8ef90a(), $03deb23ff14920c4$export$4eaf04e54aa8eed6(), $07b14b47974efb58$var$PopoverInner(), $18f2051aff69b9bf$export$43bb16f9c6d9e3f7(), $1dbecbe27a04f9af$export$14d238f342723f25(), $1e5a04cdaf7d1af8$export$188ec29ebc2bdc3a(), $204d9ebcedfb8806$export$ed5abd763a836edc() (+332 more)

### Community 5 - "User Domain Models"

Cohesion: 0.02
Nodes (85): AffiliateService, CreateAffiliateLinkDto, RequestPayoutDto, UpdateAffiliateStatusDto, CreateAiTaskDto, ApplyFlashSaleSlotDto, LogParams, CandidateProduct (+77 more)
...
Cohesion: 0.01
Nodes (287): allowsNameFromContent(), areObjectsEqual(), arrayFrom(), asFlatString(), asFlatString2(), assertKeys(), assertTypes(), asymmetricMatch() (+279 more)

### Community 8 - "Client Entity Types"

Cohesion: 0.02
Nodes (88): AdsModule, AdsModule, AdvancedSearchModule, AdvancedSearchModule, AffiliateController, AffiliateModule, AffiliateModule, AiToolsController (+80 more)

### Community 9 - "Browser Client Types"

Cohesion: 0.01
Nodes (262): $2a41e45df1593e64$var$translateRTL(), $9bf71ea28793e738$var$isTabbableRadio(), alloc(), arrayFromSet(), arrayFromSet2(), \_arrayLikeToArray(), \_arrayWithoutHoles(), assembleLineNumberStyles() (+254 more)
...
Cohesion: 0.02
Nodes (135): AdminAuthGuard, getSessionIdFromRequest(), toAdminSessionData(), AuditLogInterceptor, AuditLogQueryDto, AuditLogResponseDto, AuditLogService, AuditLogsController (+127 more)

### Community 13 - "Loyalty Account Models"

Cohesion: 0.02
Nodes (218): $0065b146e7192841$export$7138b0d059a6e743(), $0175d55c2a017ebc$export$fdf4756d5b8ef90a(), $03deb23ff14920c4$export$4eaf04e54aa8eed6(), $07b14b47974efb58$var$PopoverInner(), $18f2051aff69b9bf$export$43bb16f9c6d9e3f7(), $1dbecbe27a04f9af$export$14d238f342723f25(), $1e5a04cdaf7d1af8$export$188ec29ebc2bdc3a(), $204d9ebcedfb8806$export$ed5abd763a836edc() (+210 more)

### Community 14 - "Ad Domain Models"

Cohesion: 0.05
Nodes (61): ApiCreatedResponseData(), ApiOkResponseData(), isModelArray(), isSwaggerClass(), ApprovalQueryDto, TEMPLATES_DIR, SessionProvider, BulkJobQueryDto (+53 more)
...
Cohesion: 0.02
Nodes (210): addPressed(), assertPointerEvents(), assignProps(), attachClipboardStubToView(), blurElement(), calculateNewValue(), checkPointerEvents(), clear() (+202 more)

### Community 17 - "Return Request Models"

Cohesion: 0.02
Nodes (191): addPressed(), assertPointerEvents(), attachClipboardStubToView(), calculateNewValue(), checkPointerEvents(), clear(), clear2(), clearInitialValue() (+183 more)

### Community 18 - "Review Domain Models"

Cohesion: 0.02
Nodes (68): handleConnection(), handleDisconnect(), handleHeartbeat(), trackPresence(), untrackPresence(), ChatAdminService, existingConversation, prisma (+60 more)
...
Cohesion: 0.02
Nodes (153): $488c6ddbf4ef74c2$var$getCachedNumberFormatter(), $507fabe10e71c6fb$var$handleFocusEvent(), $507fabe10e71c6fb$var$handleKeyboardEvent(), $507fabe10e71c6fb$var$handlePointerEvent(), $507fabe10e71c6fb$var$isValidKey(), $507fabe10e71c6fb$var$triggerChangeHandlers(), a(), addChainableMethod() (+145 more)

### Community 21 - "Community 21"

Cohesion: 0.02
Nodes (150): $7d2416ea0959daaa$export$e989c0fffaa6b27a(), $7d2416ea0959daaa$var$isAttributeVisible(), $7d2416ea0959daaa$var$isStyleVisible(), $8a9cb279dc87e130$export$cabe61c495ee3649(), allowsNameFromContent(), arrayFrom(), asFlatString(), asymmetricMatch() (+142 more)

### Community 22 - "Community 22"

Cohesion: 0.02
Nodes (148): $319e236875307eab$export$a9b970dcc4ae71a9(), $337b884510726a0d$export$c6fdb837b070b4ff(), $488c6ddbf4ef74c2$var$getCachedNumberFormatter(), $64fa3d84918910a7$export$2881499e37b75b9a(), $96b38030c423d352$export$78efe591171d7d45(), $96b38030c423d352$export$9fc1347d4195ccb3(), $9bf71ea28793e738$export$1258395f99bf9cbf(), $9bf71ea28793e738$export$20e40289641fbbb6() (+140 more)
...
Cohesion: 0.03
Nodes (64): Approval, ApprovalsResponse, BulkJob, BulkJobsResponse, ChatMessage, Conversation, ConversationsResponse, MessagesResponse (+56 more)

### Community 25 - "Community 25"

Cohesion: 0.03
Nodes (133): $14c0b72509d70225$export$b0d6fa1ab32e3295(), $21f1aa98acb08317$export$c57958e35f31ed73(), $2f04cbc44ee30ce0$export$53a0910f038337bd(), $2f04cbc44ee30ce0$export$c826860796309d1b(), $2f04cbc44ee30ce0$var$relativeOffset(), $49c51c25361d4cd2$var$addEvent(), $49c51c25361d4cd2$var$preventScrollMobileSafari(), $49c51c25361d4cd2$var$scrollIntoView() (+125 more)
...
Cohesion: 0.02
Nodes (131): a(), addChainableMethod(), addLengthGuard(), addListener(), addMethod(), addProperty(), an(), assemble() (+123 more)
...
Cohesion: 0.02
Nodes (122): $488c6ddbf4ef74c2$export$711b50b3c525e0f2(), $5b160d28a433310d$var$getLanguage(), $5b160d28a433310d$var$getStringsForLocale(), align(), clone2(), collectOwnProperties(), compareObjects(), comparePrimitive() (+114 more)
...
Cohesion: 0.03
Nodes (119): $14c0b72509d70225$export$b0d6fa1ab32e3295(), $2f04cbc44ee30ce0$export$53a0910f038337bd(), $2f04cbc44ee30ce0$export$c826860796309d1b(), $2f04cbc44ee30ce0$var$relativeOffset(), $9446cca9a3875146$export$7d15b64cf5a3a4c4(), $a40c673dc9f6d9c7$export$94ed1c92c7beeb22(), append(), applyStyles() (+111 more)

### Community 34 - "Community 34"

Cohesion: 0.02
Nodes (117): $488c6ddbf4ef74c2$export$711b50b3c525e0f2(), $5b160d28a433310d$var$getLanguage(), $5b160d28a433310d$var$getStringsForLocale(), align(), clone2(), collectOwnProperties(), compareObjects(), comparePrimitive() (+109 more)
...
Cohesion: 0.03
Nodes (68): Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage(), Button(), buttonVariants (+60 more)
...
Cohesion: 0.04
Nodes (50): CreateProductDto, ProductImageDto, ProductVariantDto, VariantOptionGroupDto, VariantOptionValueDto, CreateProductDto, ProductImageDto, ProductVariantDto (+42 more)
...
Cohesion: 0.03
Nodes (23): AuthController, data, getClientIp(), getCookieValue(), getSessionIdFromRequest(), AuthService, parseAdminSessionData(), AuthController (+15 more)

### Community 51 - "Community 51"

Cohesion: 0.04
Nodes (26): CheckoutController, CheckoutModule, CheckoutService, toPaymentMethodInput(), QueueName, QUEUES, CheckoutSessionDto, ConfirmCheckoutDto (+18 more)
...
Cohesion: 0.03
Nodes (59): useIsMobile(), Default, Group, meta, Story, ReviewSheet(), ReviewSheetProps, SidebarMenuRenderer() (+51 more)

### Community 56 - "Community 56"

Cohesion: 0.04
Nodes (64): CategoryHierarchy(), CategoryDetailsCard(), CategoryHierarchyClient(), CategoryHierarchyClientProps, CategorySeoCard(), buildCategoryHierarchyState(), CategoryHierarchyAction, CategoryHierarchyControllerProps (+56 more)
...
Cohesion: 0.05
Nodes (42): approveRefund(), getRefund(), getRefunds(), getRefundStatusCounts(), RefundListItem, rejectRefund(), AuditLogPageClient(), CategoryHierarchyPageClient() (+34 more)
...
Cohesion: 0.04
Nodes (40): authClient, { AuthProvider, useAuth }, { client }, { protectedRoute }, MessagesPageClient(), SellerLayout(), SellerLayout(), useMessagesAdapter() (+32 more)
...
Cohesion: 0.05
Nodes (51): approveProduct(), bulkApproveProducts(), bulkRejectProducts(), getProduct(), getProducts(), getProductStatusCounts(), hideProduct(), ProductApproveBody (+43 more)
...
Cohesion: 0.05
Nodes (49): Campaigns(), CampaignsClient(), CampaignsClientProps, StatusDot(), StatusLabel(), VouchersClient(), VouchersClientProps, CAMPAIGN_STATUS_DOT_CLASS (+41 more)
...
Cohesion: 0.03
Nodes (17): AnalyticsService, BundleErrorKey, DashboardBundle, DashboardService, ReturnQueryDto, NotificationModel, NotificationQueryParams, NotificationService (+9 more)
...
Cohesion: 0.05
Nodes (25): ChannelRouterService, dedupeChannels(), EmailChannel, TEMPLATE_PATH, InAppChannel, PushChannel, ChannelDeliveryResult, NotificationDeliveryPayload (+17 more)

### Community 100 - "Community 100"

Cohesion: 0.07
Nodes (50): Home(), StorefrontHomePage(), useProtectedRoute(), UseProtectedRouteOptions, MessagesPageClient(), NotificationsPageClient(), mapHomepageToHomeContent(), createStorefrontRealtimeSocket() (+42 more)
...
Cohesion: 0.05
Nodes (68): $, a, Ao(), b(), componentDidUpdate(), d, E(), e2() (+60 more)

### Community 104 - "Community 104"

Cohesion: 0.05
Nodes (29): ProductDetailBreadcrumbDto, ProductDetailMediaDto, ProductDetailOptionDto, ProductDetailOptionGroupDto, ProductDetailProductDto, ProductDetailProductStatusFlagsDto, ProductDetailPurchaseOptionsDto, ProductDetailQuantityDto (+21 more)

### Community 105 - "Community 105"

Cohesion: 0.05
Nodes (66): ah(), Bb(), bh(), Bt(), CA(), Cg(), Ch(), Db() (+58 more)

### Community 106 - "Community 106"

Cohesion: 0.05
Nodes (64): $(), A(), Ao(), b(), componentDidUpdate(), D(), E(), e2() (+56 more)
...
Cohesion: 0.05
Nodes (61): offset(), addEccAndInterleave(), appendBits(), applyMask(), assert(), \_check_private_redeclaration(), \_class_apply_descriptor_get(), \_class_apply_descriptor_set() (+53 more)
...
Cohesion: 0.07
Nodes (25): calculateSubtotal(), CART_INCLUDE, CartRecord, CartService, ensureQuantityAvailable(), formatVariantLabel(), getItemAvailableStock(), getItemUnitPrice() (+17 more)
...
Cohesion: 0.07
Nodes (45): ChatConversationResponse, ChatDetailDto, ChatMessageDto, ChatMessagesResponse, ChatsResponse, ChatSummaryDto, createChatConversation(), CreateChatConversationBody (+37 more)

### Community 127 - "Community 127"

Cohesion: 0.06
Nodes (28): AdminProfile, getAdminProfile(), loginAdmin(), LoginBody, LoginResponse, logoutAdmin(), LogoutResponse, ProfileResponse (+20 more)

### Community 128 - "Community 128"

Cohesion: 0.06
Nodes (27): OrderDetailPageClient(), OrderDetailPageClientProps, OrdersPageClient(), OrdersPageClientProps, useOrders(), useOrdersList(), useOrderStatusCounts(), useOrdersAdapter() (+19 more)

### Community 129 - "Community 129"

Cohesion: 0.05
Nodes (58): t2(), isObject2(), $64fa3d84918910a7$export$29f1550f4b0d4415(), $64fa3d84918910a7$export$fabf2dc03a41866e(), applyStyle(), canHaveLength(), canHaveLength2(), checkEquality() (+50 more)
...
Cohesion: 0.07
Nodes (40): AppModule, buildSwaggerDocument(), SwaggerConfig, CheckoutProcessorModule, generate(), getAdminPort(), getAdminThrottleConfig(), getCorsOrigins() (+32 more)
...
Cohesion: 0.06
Nodes (56): \_0(), Ag(), au(), Ba(), Bf(), \_c(), c0(), Cc() (+48 more)
...
Cohesion: 0.04
Nodes (31): CurrencyInput, CurrencyInputProps, DatePicker(), DateRangePicker(), DatePickerProps, DateRangePickerProps, DateRangeValue, NumberInput (+23 more)
...
Cohesion: 0.07
Nodes (33): forceCancelOrder(), forceCompleteOrder(), getOrder(), getOrders(), getOrderStatusCounts(), OrderActionBody, OrderActionResponse, OrderDetailResponse (+25 more)

### Community 142 - "Community 142"

Cohesion: 0.05
Nodes (11): CreateCurrencyDto, CreateRegionDto, CreateTranslationDto, I18nController, CreateCurrencyDto, CreateRegionDto, CreateTranslationDto, I18nService (+3 more)

### Community 143 - "Community 143"

Cohesion: 0.06
Nodes (53): adjustHue(), colorToHex(), colorToInt(), convertToHex(), convertToInt(), createStringFromObject(), css(), darken() (+45 more)

### Community 144 - "Community 144"

Cohesion: 0.05
Nodes (52): Ac(), Ag(), an(), au(), Bf(), bg(), \_c(), Cc() (+44 more)
...
Cohesion: 0.06
Nodes (26): SetStateAction, useControllableState(), UseControllableStateOptions, ConversationItem(), ConversationItemProps, ConversationSidebarProps, EmptyPanelProps, MessageComposerProps (+18 more)
...
Cohesion: 0.08
Nodes (31): ProductsClient(), ProductsClientProps, priceColumn, productColumn, productsColumns, ratingColumn, selectColumn, soldColumn (+23 more)
...
Cohesion: 0.06
Nodes (33): Dashboard(), Dashboard(), dashboardAuditEvents, dashboardCampaigns, dashboardDefaultProps, dashboardDisputeQueue, dashboardLowStockItems, dashboardMetrics (+25 more)
...
Cohesion: 0.05
Nodes (10): AddLivestreamProductDto, CreateLivestreamDto, PinProductDto, LivestreamController, AddLivestreamProductDto, CreateLivestreamDto, PinProductDto, LivestreamController (+2 more)
...
Cohesion: 0.06
Nodes (11): CreateWarehouseDto, CreateWarehouseDto, StockQueryDto, TransferQueryDto, WarehouseQueryDto, StockQueryDto, TransferQueryDto, WarehouseQueryDto (+3 more)

### Community 159 - "Community 159"

Cohesion: 0.09
Nodes (18): CategoryPageController, CategoryPageModule, CategoryPageService, createPrismaMock(), prisma, service, CATEGORY_PAGE_SORTS, CategoryBreadcrumbDto (+10 more)
...
Cohesion: 0.09
Nodes (40): ah(), bh(), Bt(), Ch(), fh(), fp(), gh(), \_h() (+32 more)
...
Cohesion: 0.06
Nodes (13): AdsController, UpdateAdCampaignStatusDto, AdsService, UpdateAdCampaignStatusDto, AdsService, AdKeywordDto, CreateAdCampaignDto, CreateAdDto (+5 more)
...
Cohesion: 0.06
Nodes (39): $03deb23ff14920c4$export$4eaf04e54aa8eed6(), $18f2051aff69b9bf$export$43bb16f9c6d9e3f7(), $1e5a04cdaf7d1af8$export$188ec29ebc2bdc3a(), $2a41e45df1593e64$export$d39e1813b3bdd0e1(), $2a41e45df1593e64$var$useResize(), $326e436e94273fe1$export$1c4b08e0eca38426(), $3ef42575df84b30b$export$9d1611c77c2fe928(), $458b0a5536c1a7cf$export$40bfa8c7b0832715() (+31 more)

### Community 172 - "Community 172"

Cohesion: 0.08
Nodes (23): createNotification(), createTemplate(), getNotifications(), getTemplates(), NotificationListItem, NotificationTemplate, sendNotification(), col (+15 more)
...
Cohesion: 0.1
Nodes (19): CategoryDetail, CategoryNode, createCategory(), deleteCategory(), getCategories(), getCategory(), reorderCategories(), updateCategory() (+11 more)
...
Cohesion: 0.11
Nodes (18): SellersKycClient(), buildSellersKycColumns(), buildSellerKycStatusCounts(), filterSellerKycItems(), SellersKycControllerResult, useSellersKycController(), sellersKycDefaultProps, SellersKyc() (+10 more)
...
Cohesion: 0.1
Nodes (13): NotificationsPageClient(), NotificationsPageClientProps, useSendNotification(), useNotifications(), useNotificationsAdapter(), mapNotificationsToRows(), getNotifications(), markAllNotificationsRead() (+5 more)
...
Cohesion: 0.1
Nodes (18): AuditLog, getAuditLogs(), buildPaginatedResponse(), buildPaginationMeta(), AuditLogsPage(), AuditLogPageClient(), buildPaginatedResponse(), buildPaginationMeta() (+10 more)
...
Cohesion: 0.1
Nodes (17): DashboardInsightsSection(), BasicInfoSection(), ProductDetailClientProps, ProductDetailContent(), ProductMediaSection(), PRODUCT_DETAIL_ACTION_LABELS, useProductEditorBasicInfo(), useProductEditorContext() (+9 more)
...
Cohesion: 0.09
Nodes (14): metadata, RootLayout(), getUserInitials(), getUserString(), StorefrontShell(), useProtectedRoute(), UseProtectedRouteOptions, RootLayout() (+6 more)

### Community 195 - "Community 195"

Cohesion: 0.09
Nodes (32): allowsNameFromContent2(), arrayFrom2(), findLabelableElement2(), getControlOfLabel2(), getLabels2(), getLocalName2(), getSlotContents2(), getValueOfTextbox2() (+24 more)
...
Cohesion: 0.09
Nodes (29): bg(), Cu(), Dg(), Du(), Ec(), eo(), Fg(), Fu() (+21 more)
...
Cohesion: 0.07
Nodes (7): CreateEventSubscriptionDto, EmitEventDto, EventStreamingController, CreateEventSubscriptionDto, EmitEventDto, EventStreamingController, EventStreamingService
...
Cohesion: 0.11
Nodes (18): OrderDetail, OrderListItem, mapOrderToRecord(), mapProductToApprovalItem(), toApprovalStatus(), formatSellerKycGmv(), DateValue, DEFAULT_DATE_TIME_FORMAT (+10 more)
...
Cohesion: 0.11
Nodes (23): Bb(), eo(), Fg(), hd(), ht(), Ig(), It(), jb() (+15 more)
...
Cohesion: 0.13
Nodes (11): AuthContextValue, AuthUser, CreateAuthClientOptions, WithAuthOptions, ProtectedRouteOptions, AuthContextValue, CreateAuthClientOptions, AuthUser (+3 more)
...
Cohesion: 0.24
Nodes (9): WarehousesClient(), WarehousesClientProps, mockWarehouses, Default, Story, WarehouseRow, WarehousesProps, warehousesColumns (+1 more)
...
Cohesion: 0.2
Nodes (11): fp(), Hm(), hn(), Hs(), Mt(), Us(), Vm(), vs() (+3 more)
...
Cohesion: 0.22
Nodes (8): code:block1 (ProductsService → ProductsRepository → Prisma), Docs, Ecommerce Marketplace, Quick Start, Repository Pattern, Requirements, Scripts, Swagger / OpenAPI
...
Cohesion: 0.25
Nodes (8): code:typescript ({ success: true, data: T, timestamp: string }), Error Handling, Immutability, Key Patterns, Local infrastructure, Multi-Seller Order Flow, Response Wrapping, Session Management
...
- **9154 isolated node(s):** `[t,r,n,o]`, `[o,i,a]`, `[r,n]`, `[o,i]`, `[a,s]` (+9149 more)
...
- **Why does `Boolean` connect `Community 56` to `Community 104`, `Product Domain Models`, `Community 163`?**
  _High betweenness centrality (0.388) - this node is a cross-community bridge._
- **Why does `number()` connect `Return Request Models` to `Prisma Schema Enums`, `Prisma Filter Types`, `Shop Domain Models`, `Seller Order Models`, `User Domain Models`, `Community 392`, `Community 141`, `Community 142`, `Community 21`, `Community 149`, `Community 24`, `Community 27`, `Community 34`, `Community 166`, `Community 169`, `Community 192`, `Community 324`, `Community 197`, `Community 327`, `Community 72`, `Community 208`, `Community 87`, `Community 217`, `Community 97`, `Community 98`, `Community 103`, `Community 121`?**
  _High betweenness centrality (0.244) - this node is a cross-community bridge._
- **Why does `format()` connect `Community 34` to `Prisma Schema Enums`, `Shop Domain Models`, `Seller Order Models`, `Community 138`, `Return Request Models`?**
