...
type ShopProfilePageClientProps = { initialData?: Parameters<typeof useShopProfileAdapter>[0] }

export function ShopProfilePageClient({ initialData }: ShopProfilePageClientProps) {
  const { formData, onSubmit } = useShopProfileAdapter(initialData)
