          ...
          patterns: [
            {
              ...
              message:
                '@ecom/shared is a leaf package — it cannot import internal workspace packages. Use external libs only.',
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              ...
              message:
                '@ecom/contracts is a stable leaf layer — it cannot import from @ecom/shared.',
            },
            {
              group: ['@nestjs/swagger', '@nestjs/swagger/*'],
              message:
                '@ecom/contracts MUST NOT import @nestjs/swagger. Use class-validator only. Add @ApiProperty in packages/nestjs-openapi or apps/api-* instead.',
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              group: [
                '@ecom/database',
                '@ecom/nestjs-core',
                '@ecom/shared/pagination/prisma',
                '@ecom/shared/pagination/nestjs',
              ],
