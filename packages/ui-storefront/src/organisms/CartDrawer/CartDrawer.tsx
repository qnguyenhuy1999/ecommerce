  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-[90vw] sm:max-w-sm flex flex-col p-0 border-l border-[var(--border-subtle)] bg-[var(--surface-base)] shadow-[var(--elevation-modal)]">
        {/* Header */}
        <SheetHeader className="px-[var(--space-5)] py-[var(--space-4)] border-b border-[var(--border-subtle)]">
        ...
        <div className="flex-1 overflow-hidden flex flex-col bg-[var(--surface-muted)]/30">
          ...
          {localItems.length > 0 && (
            <div className="px-[var(--space-5)] py-[var(--space-4)] bg-[var(--surface-base)] border-b border-[var(--border-subtle)] shadow-sm z-10 relative">
          ...
          {localItems.length > 0 && (
            <div className="bg-[var(--surface-base)] border-t border-[var(--border-subtle)] z-20 shadow-[var(--elevation-up-1)] relative p-[var(--space-5)] flex flex-col gap-[var(--space-4)]">
              {/* Promo code */}
