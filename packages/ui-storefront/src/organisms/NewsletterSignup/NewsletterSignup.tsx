...
function NewsletterSignup({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'relative mx-auto mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full',
          isDark
      ...
      <p
        className={cn(
          'relative mx-auto mt-2 max-w-md text-sm leading-[var(--line-height-relaxed)]',
      ...
      {status === 'success' ? (
        <div className="relative mt-6 flex flex-col items-center animate-in fade-in slide-in-from-bottom-2 duration-[var(--motion-normal)] fill-mode-both">
          <div
            className={cn(
          ...
          <button
            type="button"
            className={cn(
              'mt-3 text-[length:var(--text-xs)] font-medium underline-offset-4 hover:underline',
        ...
        <form
          ...
          className="relative mx-auto mt-6 flex w-full max-w-md flex-col gap-2 sm:flex-row"
        >
          ...
          <Button
            ...
            variant="brand"
            size="lg"
            className="h-11 rounded-full px-6 shrink-0 gap-2"
      ...
      {status === 'error' && (
        <p className={cn('relative mt-2 text-[length:var(--text-xs)] text-[var(--intent-danger)]')}>
