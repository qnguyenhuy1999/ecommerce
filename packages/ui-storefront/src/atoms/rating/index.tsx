...
function Rating({ value, max = 5, size = 'default', showCount = false, count, className, ...props }: RatingProps) {
  ...
  return (
    <div className={cn("flex items-center gap-1.5", className)} {...props}>
      <div className="flex items-center gap-0.5" aria-label={`Rating: ${safeValue} out of ${max} stars`}>
