...
function PromoBar({ message, link, dismissible = false, variant = 'brand', className, ...props }: PromoBarProps) {
  ...
  return (
    ...
    >
      {link ? (
        <a href={link} className="absolute inset-0 z-0 flex items-center justify-center hover:underline underline-offset-4 decoration-current/50">
