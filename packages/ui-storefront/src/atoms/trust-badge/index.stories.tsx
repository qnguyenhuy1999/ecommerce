...
import { TrustBadge, TrustBadgeGroup } from './index'

const meta: Meta<typeof TrustBadge> = {
  title: 'ui-storefront/atoms/TrustBadge',
...
export const GroupPipeSeparator: Story = {
  render: () => (
    <TrustBadgeGroup
      types={['free-shipping', 'free-returns', 'authentic']}
      size="default"
      separator="pipe"
    />
  ),
...
export const GroupNoSeparator: Story = {
  render: () => (
    <TrustBadgeGroup
      types={['verified-seller', 'free-shipping', 'secure-checkout']}
      size="default"
      separator="none"
    />
  ),
