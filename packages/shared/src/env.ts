...
// Full env - merge all
export const envSchema = appEnvSchema.merge(dbEnvSchema).merge(redisEnvSchema)
  .merge(jwtEnvSchema).merge(stripeEnvSchema).merge(emailEnvSchema)
  .merge(queueEnvSchema).merge(securityEnvSchema).merge(rateLimitEnvSchema);
