...
const dialogContentVariants = cva(
  [
    ...
    'data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[calc(50%-var(--space-6))]',
    'data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[calc(50%-var(--space-6))]',
  ].join(' '),
  {
    variants: {
      size: {
