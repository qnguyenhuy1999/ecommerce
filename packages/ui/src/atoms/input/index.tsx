    ...
    const inputElement = (
      <input
        ...
        className={cn(
          ...
          // Padding: reduced when icon present (icon takes space)
          (prefixIcon || loading) && 'pl-10',
          suffixIcon && !prefixIcon && !loading && 'pr-10',
          label && 'pt-4 pb-1', // Extra top padding for floating label
          // Shadow only on focus — not at rest
          'focus:shadow-[var(--elevation-card)]',
          // Typography
          ...
          {label && (
            <label
              className={cn(
                ...
                'peer-focus:top-2 peer-focus:-translate-y-1/2 peer-focus:text-[10px] peer-focus:text-brand',
                // If not placeholder shown, it's floating
                'top-2 -translate-y-1/2 text-[10px]',
                (prefixIcon || loading) && 'left-10',
