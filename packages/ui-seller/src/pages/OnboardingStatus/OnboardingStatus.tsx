...
import { OnboardingStatusActionButton } from './OnboardingStatus.client'
...
function PrimaryAction({ label, href, onPrimaryAction }: PrimaryActionProps) {
  if (onPrimaryAction) {
    return <OnboardingStatusActionButton label={label} onPrimaryAction={onPrimaryAction} />
  }
