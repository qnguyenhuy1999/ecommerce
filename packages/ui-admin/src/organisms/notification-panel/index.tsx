          ...
          {items.map((notification, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Swipe/Hover actions */}
                <div className="absolute right-0 top-0 bottom-0 flex items-center translate-x-full group-hover:translate-x-0 transition-transform duration-[var(--motion-fast)] bg-gradient-to-l from-background via-background to-transparent pr-4 pl-8">
                  <Button
                    size="icon"
                    variant="ghost"
