...
const meta: Meta<typeof OrderTimeline> = {
  title: 'ui-admin/molecules/OrderTimeline',
...
const ORDER_STEPS: TimelineStep[] = [
  { label: 'Order Placed', description: 'Order #ORD-2024-8847 confirmed.', timestamp: 'Apr 12, 10:32 AM', status: 'completed' },
  { label: 'Payment Verified', description: 'Payment of $149.99 processed.', timestamp: 'Apr 12, 10:35 AM', status: 'completed' },
  { label: 'Processing', description: 'Items are being picked and packed.', timestamp: 'Apr 12, 2:15 PM', status: 'completed' },
  { label: 'Shipped', description: 'Shipped via FedEx - Tracking: 7489201837462.', timestamp: 'Apr 13, 9:00 AM', status: 'current' },
...
const RETURN_STEPS: TimelineStep[] = [
  ...
  { label: 'Refund Processed', description: 'Refund of $89.99 issued to original payment method.', timestamp: 'Apr 17, 2:30 PM', status: 'current' },
  { label: 'Completed', status: 'upcoming' },
]

const FAILED_STEPS: TimelineStep[] = [
  { label: 'Order Placed', status: 'completed' },
  { label: 'Payment Failed', description: 'Card declined. Please update payment method.', timestamp: 'Apr 12, 10:35 AM', status: 'error' },
...
export const PendingOrder: Story = {
  args: {
    steps: [
      { label: 'Order Placed', description: 'Awaiting payment confirmation.', timestamp: 'Apr 17, 9:00 AM', status: 'current' },
