...
import { LayoutDashboard, ShoppingBag, Package, ShoppingCart, Users, Settings, BarChart3 } from 'lucide-react'
        ...
        <aside style={{ width: '16rem', height: '100%' }} className="flex flex-col">
          ...
          <nav className="flex-1 p-3 space-y-6 overflow-y-auto">
            {SIDEBAR_NAV.map((group, gi) => (
              <div key={gi}>
                <p className="px-2 mb-1 text-[var(--space-3)] font-bold uppercase tracking-wider text-muted-foreground">
                  {group.label}
                </p>
